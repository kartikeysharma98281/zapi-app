...
import { BACKEND_URL, HOOKS_URL } from "../cofig";
...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      {loading ? "Loading...": <div className="flex justify-center w-full"><ZapTabel zaps={zaps}/></div>}
    </div>
  );
}


function ZapTabel({zaps}:{zaps: Zap[]}){
  const router = useRouter();
